...
;
const metadata = {
    title: "Mapadata.cl — Base de Datos de Empresas en Chile",
    description: "Descarga listas de empresas verificadas de Google Maps por industria y región. Archivos CSV listos para tu CRM.",
    keywords: "empresas chile, base de datos empresas, google maps, scraping, leads b2b, chile empresas"
};
